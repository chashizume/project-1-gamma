...
The term 'vaccine 5g' was trending as early as March 15, as US COVID numbers were just starting to increase, and months before any viable vaccine was in human trials. This increase was likely related to news coverage on the topic which began as early as [May 18 ](https://maldita.es/malditaciencia/20200518/post-facebook-coronavirus-vacunas-chemtrails-5g/) but increased in early March. The BBC did an analysis of [social media posts related to the topic](https://www.bbc.com/news/53191523) and found that they had substantial reach across the globe. In this case it is actually interesting to note that searches do not seem to be well correlated with vaccination rates but rather with critical events in the vaccination timeline. We see a spike at the very beginning of the pandemic, a spike as large-scale vaccinations begin, and a few more spikes as vaccinations increase then taper off. Not all of the trends in searches can be explained by these events but they do seem to overlap with many of them.
