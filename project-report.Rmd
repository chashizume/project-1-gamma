...
ggplot() +
  geom_line(data = df_vax, aes(x = date, y = daily_vaccinations, color = "Daily Vaccinations", linetype = "Daily Vaccinations")) +
  geom_ma(data = covid_5g, ma_fun = SMA, n = 2, mapping = aes(x = date, y = hits * scale_factor, color = "Search popularity", linetype = "Search popularity")) +
  scale_y_continuous(name="Daily Vaccinations in the US", sec.axis=sec_axis(~./scale_factor, name="Popularity of Google Search")) +
  labs(
    x = "Date", 
    y = "New COVID cases, 7-day rolling average",
    title = 
